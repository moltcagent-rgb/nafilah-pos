...
// Ambil satu pesanan berdasarkan id — dipakai halaman pelacakan pesanan
// pelanggan (publik, tidak butuh login staff).
...
export async function createOrder({
  ...
  try {
    ...
    const insertResult = await tx.execute({
      sql: `INSERT INTO orders (id, order_number, customer_name, phone, order_type, delivery_address, items, total, status, created_at, updated_at)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) RETURNING *`,
      args: [
        id,
        orderNumber,
